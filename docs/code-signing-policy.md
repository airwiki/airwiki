...
While public-trust enrollment is pending, the manual **Package technical
candidates** workflow may produce a temporary Actions artifact or a permanent
public technical pre-release for testing. This exception does not use SignPath
or updater credentials and does not weaken any stable-release gate:
