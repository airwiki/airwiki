...
settings-mcp-boundary = Chat access stays on this device. Search is read-only; an authorized application can change only AI memory wikis covered by its scoped grant.
