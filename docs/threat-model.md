...
| Stable installer is altered | Proposed SignPath Foundation native publisher signature, independent Tauri updater signature, hashes/SBOM, platform gates; signing remains blocked until provider acceptance and protected configuration | Signing-key service or CI compromise remains possible |
