...
La implementación y la aceptación cotidiana están completas en las superficies
migradas. Los informes de [macOS](desktop-redesign-macos-validation.md) y
[Windows](desktop-redesign-windows-validation.md) identifican los candidatos,
separan observaciones instaladas de E2E y conservan sus límites. La integración
sigue el proceso de PR, revisión independiente y checks actuales verdes.

- [x] Fase 1: ventana mínima con 50 conceptos, W enlazada y base visual.
- [x] Fase 2: navegación contextual y Biblioteca; lateral plegable y acotado.
- [x] Fase 3: lector compartido, Fuentes del concepto y Detalles. El contrato
  no permite atribuir fuentes a párrafos; no se inventan citas precisas.
- [x] Fase 4: búsqueda compacta, resultados y retorno al contexto; recuperación
  de IA local fuera del input y consentimiento público explícito por consulta.
- [x] Fase 5: revisión dedicada, footer completo, edición conservada, decisiones
  confirmadas, evidencia obsoleta y recuperación de propuestas excluidas.
- [ ] Fase 6: ajustes simplificados aceptados; la restauración local acotada
  se entrega en el PR dependiente, validado junto a esta base.
...
comparaciones finales pasaron sin regenerarlas. Se mantienen las aserciones de
geometría y rendimiento existentes. El inicio conserva sus acciones visibles,
permite desplazar el contenido largo y explica que una carpeta puede agregarse
más adelante sin prometer que la IA ya esté preparada.

La revisión independiente completa y de los últimos ajustes no dejó hallazgos
accionables. Las reglas de publicación, evidencia vigente, acceso y privacidad
se conservan. VoiceOver/Narrator y la matriz exhaustiva siguen aplazados según
la prioridad de cierre, sin registrar como PASS lo no comprobado.
