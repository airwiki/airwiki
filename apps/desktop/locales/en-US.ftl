...
onboarding-model-retry = Retry preparing local AI
...
onboarding-skip-folder-help = You can add a folder later.
...
onboarding-summary-ai-preparing = Preparing local search
onboarding-summary-ai-setup-needed = Set up local search
onboarding-summary-ai-unavailable = Unavailable on this device
onboarding-next-step-title = Next step: prepare local search
onboarding-next-step-search = Local search is not ready yet. Prepare the optional local AI in Settings; it stays on this device after the verified download completes.
onboarding-next-step-preparing = Local search is still preparing. You can continue using AirWiki and check its progress or retry from Settings.
onboarding-open-local-ai = Open local AI settings
onboarding-model-unavailable-title = Local search is unavailable on this device
onboarding-model-unavailable-body = This device cannot prepare a supported local AI profile. You can still create and review private Wikis; local search requires a supported device. Check the hardware requirements before trying another device.
...
desktop-search-unavailable-title = Local search is unavailable
desktop-search-unavailable-body = Check local AI in Settings to see what is needed. You can write your query in the meantime.
desktop-search-unavailable-placeholder = Check local AI to search
desktop-workspace-page-unavailable = The last page is no longer available. You can choose another Wiki in Library.
desktop-workspace-restore-failed = The last reading could not be restored. You can continue from Library.
desktop-workspace-save-failed = The last reading and panel layout could not be saved. You can keep reading and try again.
...
settings-local-ai-ready-body = Preparation and search are available on this device. Your documents stay local.
settings-local-ai-explanation = How local AI works
settings-local-ai-attention = Local AI needs attention. Prepare the model again to check its files and activate search.
settings-local-ai-restart-body = Quit AirWiki completely and reopen it to activate the selected model.
...
desktop-integration-ready-body = Manage your connections and each app’s public search. Access to your Wikis is controlled in AI apps within each Wiki.
...
desktop-library-name-filter = Filter Wikis by name
desktop-library-name-clear = Clear name filter
desktop-library-name-empty-body = Try another name or clear the filters to show all Wikis.
desktop-library-filter-count = { $count } of { $total } Wikis
...
desktop-search-filter-label = Filter Wikis by source
desktop-search-history-title = Earlier results from this session
desktop-search-history-private = This device and the authorized private network were searched. Opening a concept checks its current availability.
desktop-search-history-public = This query included the public network. Choose the search scope again to refresh it.
desktop-search-history-refresh = Refresh results
desktop-search-history-expired = This search is no longer in the session history. You can start a new query.
desktop-search-history-interrupted = This search did not finish. Received results are retained; you can try again.
...
review-workspace-label = Proposal review
review-back-queue = Back to review queue
review-session-progress = Confirmed decisions: { $completed } · Pending: { $remaining }
review-comparison-view = Compare source and proposal
review-edited = Edited
review-edits-unsaved = Unsaved changes. They will apply when you approve this proposal.
review-excerpt-truncated = This excerpt is truncated.
review-decision-saving = Saving decision…
review-decision-failed = The decision could not be confirmed. Your edits are kept; check the evidence and try again.
review-changed-title = This proposal changed
review-changed-body = The source or draft no longer matches this review. Your edits remain here; open the current version before deciding.
review-open-current = Open current version
review-discard-title = Discard changes to this proposal?
review-discard-body = Your changes to its title and summary will be discarded. This action does not approve or exclude the proposal.
review-continue-editing = Keep reviewing
review-discard-action = Discard changes and leave
review-queue-updating = Updating
review-queue-restricted = Publication unavailable
review-queue-excluded = Excluded ({ $count })
review-publish-scope = Approving makes this content searchable and may make it accessible under this Wiki’s current permissions.
