...
pub(crate) const MESSAGE_IDS: &[&str] = &[
    ...
    "dashboard-subtitle",
    "dashboard-all-ready",
    "first-knowledge-eyebrow",
    "first-knowledge-title",
    "first-knowledge-subtitle",
    "journey-title",
    "journey-prepare",
    "journey-read",
    "journey-review",
    ...
    "onboarding-model-recommended",
    "onboarding-model-private",
    "onboarding-model-details",
    "onboarding-model-change-later",
    "onboarding-processing-body",
    "onboarding-processing-scanning",
    "onboarding-processing-enriching",
    "onboarding-processing-empty-title",
    "onboarding-processing-empty-body",
    "onboarding-processing-open-folder",
    "onboarding-processing-counts",
    ...
    "search-open-wiki",
    "search-origin-local",
    "search-origin-remote",
    "search-origin-remote-fallback",
    ...
    "review-issue-status",
    "review-issue-cause",
    "review-issue-cause-file-too-large",
    "review-issue-cause-unreadable",
    "review-issue-cause-invalid-utf8",
    "review-issue-cause-invalid-pdf",
    "review-issue-cause-encrypted-pdf",
    "review-issue-cause-too-many-pages",
    "review-issue-cause-no-text-layer",
    "review-issue-cause-too-many-characters",
    ...
    "review-issue-unreadable",
    "review-issue-invalid-utf8",
    "review-issue-invalid-pdf",
    "review-issue-encrypted-pdf",
    "review-issue-too-many-pages",
    "review-issue-no-text-layer",
    "review-issue-too-many-characters",
    "review-issue-processing-failed",
    "knowledge-search-evidence-title",
    "knowledge-search-evidence-locator",
    "knowledge-search-evidence-location-unknown",
    "knowledge-search-evidence-help",
    "knowledge-search-evidence-stale",
    "models-ready",
    "models-pending",
    "language-system",
    "language-spanish",
